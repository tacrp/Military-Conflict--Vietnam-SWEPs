...
SWEP.ViewSlideRecoilUp = 1.39
SWEP.ViewSlideRecoilRight = 0.55

SWEP.ViewSlideRecoilIronsightUp = 0.69
...
SWEP.IronsightPos = Vector(0.06, -4, 0) -- TODO tune (game: forward -9 right 0 up 0)
