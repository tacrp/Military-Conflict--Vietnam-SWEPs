...
// Generated by work/port_weapon.py from cscripts/weapon_dual_qspr.txt
...
SWEP.ViewModel = "models/weapons/mcv/v_dual_qspr.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_dual_qspr.mdl"
...
SWEP.RevolverFiremodePose = false
