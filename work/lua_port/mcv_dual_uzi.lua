...
// Generated by work/port_weapon.py from cscripts/weapon_dual_uzi.txt
...
SWEP.ViewModel = "models/weapons/mcv/v_dual_uzi.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_dual_uzi.mdl"
