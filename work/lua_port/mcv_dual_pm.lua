...
// Generated by work/port_weapon.py from cscripts/weapon_dual_pm.txt
...
SWEP.ViewModel = "models/weapons/mcv/v_dual_pm.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_dual_pm.mdl"
