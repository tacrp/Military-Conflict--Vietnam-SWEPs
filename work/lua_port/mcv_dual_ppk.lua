...
// Generated by work/port_weapon.py from cscripts/weapon_dual_ppk.txt
...
SWEP.ViewModel = "models/weapons/mcv/v_dual_ppk.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_dual_ppk.mdl"
