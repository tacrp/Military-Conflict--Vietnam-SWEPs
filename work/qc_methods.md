...
7. Go to all the $animations referenced in the idle $sequence and add:
   ...
   to each of them. Make sure their FPS is the same as well. While here, add "frame 1 1" to the "ironsight" animation *only*. Do not use "frame 0 1" as this will cause the weapon to twitch while in ironsights.
