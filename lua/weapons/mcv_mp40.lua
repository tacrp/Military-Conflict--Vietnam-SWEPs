...
SWEP.ViewModel = "models/weapons/mcv/v_mp40.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_mp40.mdl"
...
SWEP.DamageChestMultiplier = 2.1
SWEP.DamageStomachMultiplier = 2.05
...
// Sound
SWEP.SoundSingleShot = "MCV_Weapon_MP40.Single"
