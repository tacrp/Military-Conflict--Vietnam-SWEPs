...
// Generated by work/port_weapon.py from cscripts/weapon_mg43d.txt
...
SWEP.ViewModel = "models/weapons/mcv/v_mg43d.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_mg43d.mdl"

SWEP.BodyGroups = ""
SWEP.MagInTime = 3.17
SWEP.MagInTimeEmpty = 3.97
SWEP.MagOutTime = 0
...
SWEP.DamageHeadMultiplier = 2.05
SWEP.DamageChestMultiplier = 0.85
SWEP.DamageStomachMultiplier = 0.8
...
SWEP.ViewSlideRecoilUp = 2.72
SWEP.ViewSlideRecoilRight = 1.36
