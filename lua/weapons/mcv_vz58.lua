...
SWEP.DamageHeadMultiplier = 1.7
SWEP.DamageChestMultiplier = 0.95
SWEP.DamageStomachMultiplier = 0.9
...
SWEP.SoundReload = ""
SWEP.SoundReloadThirdPerson = "MCV_Weapon_Foley_ThirdPerson_VZ58.Reload"
SWEP.SoundSpecial1 = ""
SWEP.SoundSpecial2 = ""
