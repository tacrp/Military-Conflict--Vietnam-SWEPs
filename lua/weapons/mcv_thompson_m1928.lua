...
SWEP.ViewModel = "models/weapons/mcv/v_m1928.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_m1928.mdl"

SWEP.BodyGroups = ""

SWEP.WeaponSelectIcon = NULL

SWEP.IconOverride = "entities/mcv_m1928.png"
