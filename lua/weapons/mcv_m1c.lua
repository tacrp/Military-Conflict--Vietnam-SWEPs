...
SWEP.ViewModel = "models/weapons/mcv/v_m1c.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_m1c.mdl"
...
SWEP.RangeModifier = 0.925 // Every 500 units the damage is multiplied by rangemodifier
