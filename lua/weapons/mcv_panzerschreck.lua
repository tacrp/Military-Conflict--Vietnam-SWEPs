...
// Generated by work/port_weapon.py from cscripts/weapon_panzerschreck.txt
...
SWEP.ViewModel = "models/weapons/mcv/v_panzerschreck.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_panzerschreck.mdl"
