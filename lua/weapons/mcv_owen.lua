...
SWEP.ViewModel = "models/weapons/mcv/v_owen.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_owen.mdl"

SWEP.BodyGroups = ""

SWEP.IconOverride = "entities/mcv_owen_gun.png"
...
// Sound
SWEP.SoundSingleShot = "MCV_Weapon_Owen.Single"
