...
// Generated by work/port_weapon.py from cscripts/weapon_pk.txt
...
SWEP.ViewModel = "models/weapons/mcv/v_pk.mdl"
SWEP.WorldModel = "models/weapons/mcv/w_pk.mdl"

SWEP.BodyGroups = ""
SWEP.BeltBodygroups = {12}
SWEP.MagInTime = 2.13
SWEP.MagInTimeEmpty = 6.43
SWEP.MagOutTime = 0
SWEP.MagOutTimeEmpty = 2.97
