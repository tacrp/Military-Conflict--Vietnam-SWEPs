...
- [x] Placeables: R turns the piece 45 degrees (USE + R the other way) before planting, the ghost shows it; the tripwire stake showed the VC mine plus the stick (bodygroup option 1 is the VC mine, the blank is the last option)
